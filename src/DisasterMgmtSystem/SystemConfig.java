...
public class SystemConfig {
    ...
    public static DisasterMgmtSystem config()
    {
        ...
        EmergencyLocation el1 = disasterSystem.getEmergencyLocationDirectory().addEmergencyLocation();
        el1.setAddress("25 S Huntington Ave, Boston, MA 020120");
        
        EmergencyLocation el2 = disasterSystem.getEmergencyLocationDirectory().addEmergencyLocation();
        el2.setAddress("29 S Huntington Ave, Boston, MA 020120");
        
        EmergencyLocation el3 = disasterSystem.getEmergencyLocationDirectory().addEmergencyLocation();
        el3.setAddress("26 S Huntington Ave, Boston, MA 020120");
        
        EmergencyLocation el4 = disasterSystem.getEmergencyLocationDirectory().addEmergencyLocation();
        el4.setAddress("27 S Huntington Ave, Boston, MA 020120");
        
        EmergencyLocation el5 = disasterSystem.getEmergencyLocationDirectory().addEmergencyLocation();
