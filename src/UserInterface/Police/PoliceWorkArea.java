...
public class PoliceWorkArea extends javax.swing.JPanel {
    ...
    public void populateTable() {
        ...
        for (SOSWorkRequest workRequest : account.getWorkQueue().getWorkRequestList()) {
            ...
            row[2] = ((PoliceWaitList) workRequest).getEmergency().getDescription();
    ...
    private void initComponents() {
        ...
        phoneNumberLabel1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        phoneNumberLabel1.setText("License Plate of injured");
